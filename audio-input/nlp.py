...
# # TO DO 
#  Multi thread for running scripts for all languages side by side on jetson
# Right Now , Run the translation only on the first Language


# lanuageCodeRecieved = getCodeForLanguage(languagesInState[0])   # change for all languages later

translator = Translator()
print("TESTESTESTESTETS"+ str(languagesInState[0]))
recognized_sentence=  takeCommandInLanguageIdentified(languagesInState[0])
...
# # TO DO
# # Change the threshold value for Positive/Negative Sentiment 
